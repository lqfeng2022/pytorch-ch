...
const ChapterEight = () => {
  const cover = covers_ch[8]
  const { description: descript, items: lists } = sectionList_ch[9]
  const { name: l, link: ll } = sectionList_ch[8]
  const { name: r, link: rl } = sectionList_ch[10]
