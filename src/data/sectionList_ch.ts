export default [
  ...
  { id: 1,
    ...
    items: [
      ...
      { id: 7, name: "准备工作", link: "prerequisites" },
  ...
  { id: 2, 
    ...
    items: [
      ...
      { id: 7, name: "张量可复现性", link: "tensor-reproducibility" },
  ...
  { id: 3, 
    ...
    items: [
      ...
      { id: 2, name: "- 准备数据", link: "prepare-data" },
      { id: 3, name: "- 构建模型", link: "build-a-model" },
      { id: 4, name: "- 训练模型", link: "train-model" },
      { id: 5, name: "- 保存模型", link: "save-model" },
    ],
    description: [
      { id: 1, 
        title: "",
  ...
  { id: 5, 
    ...
    items: [
      { id: 1, name: "准备数据", link: "prepare-data" },
      { id: 2, name: "构建模型", link: "build-a-model" },
      { id: 3, name: "训练模型", link: "train-a-model" },
