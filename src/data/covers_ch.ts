export default [
  ...
  { id: 10,
    ...
    title: "自然语言",
    description: "这幅用世界各地的 ‘你好’ 组成的图画，生动地展现了人类语言的丰富性。英语、西班牙语、日语、汉语..., 每种语言都像一扇独特的窗户，让我们可以看见不同文化的风景。计算机的自然语言处理，就像一名多语种译者，帮助说不同语言的人越过沟通的障碍，实现自由交流。"
  },
  { id: 11,
    ...
    title: "什么是大语言模型 (LLMs)?",
    description: "大型语言模型，比如 ChatGPT，已经可以像人一样理解、生成和使用语言。它们通过学习大量文本，学会了语言的复杂规则和内在含义。这些模型的核心是 Transformer 架构，它让模型能够更好地理解上下文，高效处理大量自然语言。"
  },
]